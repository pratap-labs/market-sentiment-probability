...
def render_login_tab():
    ...
    st.session_state.setdefault("kite_processing_token", False)
    ...
    login_clicked = st.sidebar.button(
        "Login with Kite",
        disabled=st.session_state.kite_login_initiated,
    )
    ...
    if st.session_state.kite_login_initiated and not st.session_state.get("kite_access_token"):
        login_url = st.session_state.get("kite_login_url")
        if st.session_state.kite_redirect_pending and login_url:
